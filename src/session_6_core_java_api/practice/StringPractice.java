...
public class StringPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getStringChar("Alice", 2));
        System.out.println(isStringStartingWith("Frank", "Fre"));
        System.out.println(isStringEndingWith("Frank", "enk"));
        System.out.println(getTrimmedString("   Anna   "));
